...
<input type="submit" name="submit" class="btn btn-success" value="Apply">
    ...
    <thead>
        <tr>
            ...
            <th><a class='btn btn-primary' href=''>Author</a></th>
            <th><a class='btn btn-primary' href=''>Comment</a></th>
            ...
            <th><a class='btn btn-primary' href=''>Approve</a></th>
            <th><a class='btn btn-primary' href=''>Unapprove</a></th>
...
echo "<td><a class='btn btn-info' href='comments.php?delete=$comment_id'>Delete</a></td>";
echo "</td>";
}    
?>               
                        </tbody>
